...
const updateInvoice = async(req,res)=>{
    try{
        ...
        const {invoiceDate, invoiceValue, purchaseOrderNumber, invoiceNumber, ondcContactPocId, ondcContactPocName, files, updateRecordId, serviceAcceptanceFile} = req.body;
